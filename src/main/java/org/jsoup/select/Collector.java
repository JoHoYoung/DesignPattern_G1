...
public class Collector {
	...
	public static Elements collect(Evaluator eval, Element root) {
		...
		//MasterTraverse for_bfs = new NodeTraversor_BFS(new Accumulator(root, elements2, eval));
	...
	public static class Accumulator implements NodeVisitor { // accumulator가 NodeVisitor를 상속 -> DFS
